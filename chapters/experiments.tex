...
Tilt Brush\footnote{Tilt Brush by Google is a tool for three-dimensional painting in VR. Website: \href{https://www.tiltbrush.com/}{www.tiltbrush.com}} avoids this by identifying scenes ih the \gls{UI} with a screenshot of the scene rather than a filename. To save a scene, users get a virtual camera attached to their hands, which they then use to create a thumbnail of the current scene~\cite{GoogleLLC.2019}. % chktex 13
