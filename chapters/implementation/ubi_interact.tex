...
% TODO: write more in captions. summarize what they do
\begin{figure}[H]
	\centering
	...
	\end{subfigure} %TODO: explain in caption why topic and message format are missing
...
\begin{description}
	...
	\item[Devices] can be registered by Clients. A Device groups different input and output devices together. It is defined by a \gls{UID} and a list of Components. %TODO:  maybe state wjhat are input/output devices, take definition from components def
...
\begin{figure}[H]
	\centering
	\includegraphics[width=12cm]{figures/implementation/ubii_cd.pdf}%TODO: explain diagram in desc
