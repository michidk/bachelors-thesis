...
Since the reference system for the orientation, obtained using the Web , is fixed to the earth (see Chapter~4.1).{DevicesandSensorsWorkingGroup.2019}, also a calibration system was implemented. With the press of the \enquote{Calibrate} button, the device is calibrated to the current orientation. % TODO: change to Also a calibration system was implement
