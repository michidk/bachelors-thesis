...
The touch position on the display, is normalized to a range from zero to one. This removes the influence of the display resolution and size. Events for start and stop touching are sent on different topics. The acceleration of the smart phone is also sent to a topic, but is not used in the experiments of this thesis. % TODO: improve technicalities ("influence of the display res..."")
