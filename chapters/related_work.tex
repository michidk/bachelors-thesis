...
% TODO:
% WHY RELEVANT AND HWAT DID YOU USE ..insipiration for this thesis
% define VE (only in virtual worl)
% then remove VR from flying through \glspl{VE} in \gls{VR}
% alle zeiten vergangenheit
...
% explain more, vorteile nachteile