...
\usepackage[titles]{tocloft} % https://tex.stackexchange.com/questions/187180/spacing-problem-at-list-of-figures
\cftsetindents{figure}{0em}{3em}
\cftsetindents{table}{0em}{3em}
%\usepackage[printonlyused]{acronym} % acronyms toc and referencing
\usepackage[acronym, nonumberlist, nopostdot]{glossaries}%nomain
\makeglossaries{}
